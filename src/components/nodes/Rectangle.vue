<template>
  <div class="m-2">
    <div class="input-group input-group-sm mb-1">
      ...
      <Slider v-model="properties.size[0]" label="X" min="0.0" max="1.0" />
      <Slider v-model="properties.size[1]" label="Y" min="0.0" max="1.0" />
      <Slider v-model="properties.size[2]" label="Z" min="0.0" max="1.0" />
    </div>
    <div class="input-group input-group-sm mb-1">
      <Slider v-model="properties.feather" label="Feather" min="0.0" />
    </div>

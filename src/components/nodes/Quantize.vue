<template>
  <div class="m-2">
    <div class="input-group input-group-sm">
      <Slider v-model="properties.amount" label="Color count" min="1" max="255" decimals="0" />
    </div>
...
<script lang="ts">
import shader from "./Quantize.wgsl?raw" with { type: "text" };
...
const bindings = [
  ...
  { id: "output", index: 1, format: 0, output: true },
];
let pipeline;

<template>
  <div class="m-2">
    <div class="input-group input-group-sm mb-1">
      <Slider v-model="properties.height" label="Height" min="0" max="2" />
    </div>
    <div class="input-group input-group-sm mb-1">
      <Slider v-model="properties.length" label="Length" min="0.1" max="10" />
    </div>
    <div class="input-group input-group-sm mb-1">
      <Slider v-model="properties.steepness" label="Steepness" min="0" max="5" />
    </div>
    <div class="input-group input-group-sm mb-1">
      <Slider v-model="properties.speed" label="Speed" min="0" max="5" />
    </div>
...
<script lang="ts">
import shader from "./GerstnerWaves.wgsl?raw" with { type: "text" };

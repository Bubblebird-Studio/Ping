<template>
  <div class="m-2">
    <div class="input-group input-group-sm mb-1">
      <Slider v-model="properties.radius" label="Radius" min="0" />
    </div>
    <div class="input-group input-group-sm mb-1">
      <Slider v-model="properties.feather" label="Feather" min="0" />
    </div>
...
<script lang="ts">
import shader from "./Sphere.wgsl?raw" with { type: "text" };
